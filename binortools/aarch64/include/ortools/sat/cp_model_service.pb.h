...
inline void CpSolverRequest::set_allocated_parameters_as_string(std::string* parameters_as_string) {
  ...
  if (parameters_as_string_.IsDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited())) {
    parameters_as_string_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), "", GetArenaForAllocation());
  }
