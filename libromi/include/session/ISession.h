...
namespace romi {
        ...
        public:
                ...
                virtual bool store_jpg(const std::string& name, rpp::MemBuffer& jpeg) = 0;
                virtual bool store_png(const std::string& name, Image& image)  = 0;
                virtual bool store_svg(const std::string& name,
                                       const std::string& body) = 0;
                virtual bool store_txt(const std::string& name,
                                       const std::string& body) = 0;
                virtual bool store_path(const std::string& filename,
                                        int32_t path_number,
                                        Path& weeder_path) = 0;
