...
#define _Y(_r, _v) (((_r)->y1 - (_r)->y0 != 0.0)? (_r)->h * ((_v) - (_r)->y0) / ((_r)->y1 - (_r)->y0) : (_r)->y0)
        ...
        static void print_atdc_ij(plot_t *plot, SmoothPath& script, int i, int j, rect_t *r)
        {
        ...
        static void print_atdc(plot_t *plot, SmoothPath& script)
        {
                membuf_printf(plot->buffer,
        ...
        static void print_segment_ij(plot_t *plot, SmoothPath& script,
        ...
        static void print_segments(plot_t *plot, SmoothPath& script)
        {
                membuf_printf(plot->buffer,
                              "    <g inkscape:groupmode=\"layer\" "
        ...
        static void print_slices_ij(plot_t *plot, SmoothPath& script,
                                    int i, int j, rect_t *r)
        {
                membuf_printf(plot->buffer, "    <g transform=\"translate(%f %f)\">\n",
                              r->x, r->y);
