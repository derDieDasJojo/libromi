...
protected:
	...
	scripthublistener_tests()
                : actual_reply_text_(),
                  mockWebSocketServer_(),
                  mockWebSocket_(),
                  mockInputDevice_(),
                  mockDisplay_(),
                  mockSpeedController_(),
                  mockNavigation_(),
                  mockEventTimer_(),
                  mockMenu_(),
                  mockScriptEngine_(),
...
public:
        ...
        MockWebSocketServer mockWebSocketServer_;
...
TEST_F(scripthublistener_tests, can_construct_scripthublistener)
{
        ...
        romi::Rover rover(mockInputDevice_,
                          mockDisplay_,
                          mockSpeedController_,
                          mockNavigation_,
                          mockEventTimer_,
...
TEST_F(scripthublistener_tests, onmessage_binary_message_throws)
{
        ...
        // Act
        // Assert
        ASSERT_THROW(scriptHubListener->onmessage(mockWebSocketServer_,
                                                  mockWebSocket,
                                                  request,
                                                  rcom::kBinaryMessage),
                     runtime_error);
...
TEST_F(scripthublistener_tests, onmessage_list_returns_json)
{
        ...
        // Act
        scriptHubListener->onmessage(mockWebSocketServer_,
                                     mockWebSocket_,
                                     request,
                                     rcom::kTextMessage);
