...
TEST_F(file_utils_tests, write_vector_as_uint8_throws_on_fail)
{
        ...
        // Act
        // Assert
        ASSERT_THROW(FileUtils::TryWriteVectorAsFile(filename, output),
                     std::ostream::failure);
}
...
TEST_F(file_utils_tests, read_vector_as_uint8_throws_on_fail)
{
        ...
        // Act
        // Assert
        ASSERT_THROW(FileUtils::TryReadFileAsVector(filename, input),
                     std::istream::failure);
}
...
TEST_F(file_utils_tests, write_string_throws_on_fail)
{
        ...
        // Act
        ASSERT_THROW(FileUtils::TryWriteStringAsFile(filename, output),
                     std::ostream::failure);
}
