...
/*
  ...
  Modified by PH for ROMI - August 2021
 ...
 *          Wire object
 */
Romi_Adafruit_BNO055::Romi_Adafruit_BNO055(uint8_t address, TwoWire *theWire)
{
        _address = address;
        _wire = theWire;
}
 ...
 */
bool Romi_Adafruit_BNO055::begin(adafruit_bno055_opmode_t mode)
{
 ...
 *            OPERATION_MODE_NDOF]
 */
void Romi_Adafruit_BNO055::setMode(adafruit_bno055_opmode_t mode)
{
        _mode = mode;
 ...
 *           REMAP_CONFIG_P7]
 */
void Romi_Adafruit_BNO055::setAxisRemap(adafruit_bno055_axis_remap_config_t remapcode)
{
 ...
 *           REMAP_SIGN_P7]
 */
void Romi_Adafruit_BNO055::setAxisSign(adafruit_bno055_axis_remap_sign_t remapsign)
{
        adafruit_bno055_opmode_t modeback = _mode;
 ...
 */
void Romi_Adafruit_BNO055::setExtCrystalUse(boolean usextal)
{
        adafruit_bno055_opmode_t modeback = _mode;
 ...
 *           system error info
 */
void Romi_Adafruit_BNO055::getSystemStatus(uint8_t *system_status,
 ...
 *          revision info
 */
void Romi_Adafruit_BNO055::getRevInfo(adafruit_bno055_rev_info_t *info)
{
        uint8_t a, b;
 ...
 */
void Romi_Adafruit_BNO055::getCalibration(uint8_t *sys, uint8_t *gyro,
 ...
 */
int8_t Romi_Adafruit_BNO055::getTemp()
{
 ...
 */
Vector3 Romi_Adafruit_BNO055::getVector(adafruit_vector_type_t vector_type)
{
        Vector3 v;
        uint8_t buffer[6];
        memset(buffer, 0, 6);
 ...
 */
Vector3 Romi_Adafruit_BNO055::getEuler()
{
        return getVector(Romi_Adafruit_BNO055::VECTOR_EULER);
}

Vector3 Romi_Adafruit_BNO055::getLinearAcceleration()
{
        return getVector(Romi_Adafruit_BNO055::VECTOR_LINEARACCEL);
}

Vector3 Romi_Adafruit_BNO055::getAcceleroMeter()
{
        return getVector(Romi_Adafruit_BNO055::VECTOR_ACCELEROMETER);
}

Vector3 Romi_Adafruit_BNO055::getGyroscope()
{
        return getVector(Romi_Adafruit_BNO055::VECTOR_GYROSCOPE);
}

Vector3 Romi_Adafruit_BNO055::getMagnetoMeter()
{
        return getVector(Romi_Adafruit_BNO055::VECTOR_MAGNETOMETER);
}

Vector3 Romi_Adafruit_BNO055::getGravity()
{
        return getVector(Romi_Adafruit_BNO055::VECTOR_GRAVITY);
}
 ...
 */
Quaternion Romi_Adafruit_BNO055::getQuaternion()
{
        uint8_t buffer[8];
        memset(buffer, 0, 8);
 ...
 */
bool Romi_Adafruit_BNO055::getSensorOffsets(adafruit_bno055_offsets_t &offsets_type)
{
 ...
 */
void Romi_Adafruit_BNO055::setSensorOffsets(const adafruit_bno055_offsets_t &offsets_type)
{
        adafruit_bno055_opmode_t lastMode = _mode;
        setMode(OPERATION_MODE_CONFIG);
        delay(25);
 ...
 */
bool Romi_Adafruit_BNO055::isFullyCalibrated()
{
 ...
 */
void Romi_Adafruit_BNO055::enterSuspendMode()
{
        adafruit_bno055_opmode_t modeback = _mode;
 ...
 */
void Romi_Adafruit_BNO055::enterNormalMode()
{
        adafruit_bno055_opmode_t modeback = _mode;
 ...
 */
bool Romi_Adafruit_BNO055::write8(adafruit_bno055_reg_t reg, byte value)
{
 ...
 */
byte Romi_Adafruit_BNO055::read8(adafruit_bno055_reg_t reg)
{
        byte value = 0;
 ...
 */
bool Romi_Adafruit_BNO055::readLen(adafruit_bno055_reg_t reg, byte *buffer, uint8_t len)
{
        _wire->beginTransmission(_address);
#if ARDUINO >= 100
        _wire->write((uint8_t)reg);
