 ...
 */
#ifndef _AZHOO_AZHOOCOMMANDS_H
#define _AZHOO_AZHOOCOMMANDS_H

#include <IRomiSerial.h>
#include "IAzhoo.h"

void setup_commands(IAzhoo *azhoo, romiserial::IRomiSerial *romiSerial);
void handle_commands();

void send_info(romiserial::IRomiSerial *romiSerial, int16_t *args, const char *string_arg);
void send_encoders(romiserial::IRomiSerial *romiSerial, int16_t *args, const char *string_arg);
void handle_configure(romiserial::IRomiSerial *romiSerial, int16_t *args, const char *string_arg);
